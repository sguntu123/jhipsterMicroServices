...
import static com.jhipster.demo.product.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).productSize(UPDATED_PRODUCT_SIZE);
