...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'airman' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('until pivot');
      cy.get(`[data-cy="name"]`).should('have.value', 'until pivot');

      cy.get(`[data-cy="description"]`).type('phew sate wherever');
      cy.get(`[data-cy="description"]`).should('have.value', 'phew sate wherever');
