...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'whose among miscalculate', price: 31379.8, productSize: 'XL' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('minor lyre');
      cy.get(`[data-cy="name"]`).should('have.value', 'minor lyre');

      cy.get(`[data-cy="description"]`).type('dowse loftily shady');
      cy.get(`[data-cy="description"]`).should('have.value', 'dowse loftily shady');

      cy.get(`[data-cy="price"]`).type('21713.38');
      cy.get(`[data-cy="price"]`).should('have.value', '21713.38');
